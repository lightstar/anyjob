...
их выполнение. На данном этапе находится в состоянии *бета* и уже довольно долгое время используется
...
требуется написание своего исполняемого файла, классов и т.п.

2. Каких-либо автоматических тестов сейчас нет, тестирование осуществляется только вручную.

3. Как для хранилища данных, так и для очередей сообщений используется исключительно *redis*.

4. Все сообщения, отображаемые приложениями, сейчас только на английском языке.
